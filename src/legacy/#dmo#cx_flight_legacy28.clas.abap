CLASS /dmo/cx_flight_legacy28 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    ...
    CONSTANTS:
      gc_msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_28',

      BEGIN OF agency_unkown,
        msgid TYPE symsgid VALUE '/DMO/CM_FLIGHT_LE_28',
    ...
    METHODS constructor
      IMPORTING
        ...
        travel_id             TYPE /dmo/travel_id28 OPTIONAL
        booking_id            TYPE /dmo/booking_id28 OPTIONAL
        booking_supplement_id TYPE /dmo/booking_supplement_id28 OPTIONAL
        agency_id             TYPE /dmo/agency_id28 OPTIONAL
        customer_id           TYPE /dmo/customer_id28 OPTIONAL
        carrier_id            TYPE /dmo/carrier28-carrier_id OPTIONAL
        connection_id         TYPE /dmo/connecti_28-connection_id OPTIONAL
        supplement_id         TYPE /dmo/suppleme_28-supplement_id OPTIONAL
        begin_date            TYPE /dmo/begin_date28 OPTIONAL
        end_date              TYPE /dmo/end_date28 OPTIONAL
        booking_date          TYPE /dmo/booking_date28 OPTIONAL
        flight_date           TYPE /dmo/flight_date28 OPTIONAL
        status                TYPE /dmo/travel_status28 OPTIONAL
        currency_code         TYPE /dmo/currency_code28 OPTIONAL
        uname                 TYPE syuname OPTIONAL.

    DATA: mv_travel_id             TYPE /dmo/travel_id28,
          mv_booking_id            TYPE /dmo/booking_id28,
          mv_booking_supplement_id TYPE /dmo/booking_supplement_id28,
          mv_agency_id             TYPE /dmo/agency_id28,
          mv_customer_id           TYPE /dmo/customer_id28,
          mv_carrier_id            TYPE /dmo/carrier28-carrier_id,
          mv_connection_id         TYPE /dmo/connecti_28-connection_id,
          mv_supplement_id         TYPE /dmo/suppleme_28-supplement_id,
          mv_begin_date            TYPE /dmo/begin_date28,
          mv_end_date              TYPE /dmo/end_date28,
          mv_booking_date          TYPE /dmo/booking_date28,
          mv_flight_date           TYPE /dmo/flight_date28,
          mv_status                TYPE /dmo/travel_status28,
          mv_currency_code         TYPE /dmo/currency_code28,
...
CLASS /dmo/cx_flight_legacy28 IMPLEMENTATION.
