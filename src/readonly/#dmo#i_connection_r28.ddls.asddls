@AbapCatalog.sqlViewName: '/DMO/ICONNE_R28'
...
define view /DMO/I_Connection_R28
  as select from /dmo/connecti_28 as Connection

  association [1..*] to /DMO/I_Flight_R28 as _Flight  on  $projection.AirlineID    = _Flight.AirlineID
                                                    and $projection.ConnectionID = _Flight.ConnectionID
  association [1]    to /DMO/I_Carrier28  as _Airline on  $projection.AirlineID = _Airline.AirlineID

{
  ...
  key   Connection.connection_id    as ConnectionID,
        ...
        @Consumption.valueHelpDefinition: [{  entity: {   name: '/DMO/I_Airport28',
                              element:    'AirportID' } }]
        @Search.defaultSearchElement: true
